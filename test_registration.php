...
if(isset($_REQUEST['rSignup'])){
    ...
    if(($_REQUEST['rName'] == "") || ($_REQUEST['rEmail'] == "") || ($_REQUEST['rPassword'] == "")){
        ...
        if(strlen($password) < 8 || !preg_match("#[0-9]+#", $password) || !preg_match("#[a-zA-Z]+#", $password) || !preg_match("#[^\w]+#", $password)) {
            $regmsg = '<div class="alert alert-warning mt-2" role="alert">Password must be at least 8 characters long and contain at least one number, one letter (uppercase or lowercase), and one special character.</div>';
        } else {
...
<!-- code validation (8 char, one lower, upper, special charactor) -->
